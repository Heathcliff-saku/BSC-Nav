...
if __name__ == "__main__":
    ...
    for i in tqdm(range(1000)):
        q = habitat_benchmark_env.current_episode.question
        ...
        habitat_benchmark_env.reset()

    # 保存为json文件
    with open("eqa_questions_meta.json", "w", encoding="utf-8") as f:
        json.dump(questions_meta, f, ensure_ascii=False, indent=2)
