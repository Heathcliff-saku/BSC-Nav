...
if __name__ == "__main__":
    ...
    csv_path = "text_nav_mp3d_results_forfig.csv"
    text_goal_path = '/home/orbit/桌面/Nav-2025/data_episode/textnav/val/data'

    with open(text_goal_path, 'r', encoding='utf-8') as file:
        text_goal_file = json.load(file)
    ...
    for i in tqdm(range(args.eval_episodes)):
        ...
        # goal_img.show()
        episode_id = Robot.benchmark_env.current_episode.goal_key
        goal_text_intrinsic = text_goal_file["attribute_data"][episode_id]['intrinsic_attributes']
        goal_text_extrinsic = text_goal_file["attribute_data"][episode_id]['extrinsic_attributes']

        episode_images, episode_topdowns, episode_vedio = Robot.move2text_attributes_prompt(goal_text_intrinsic, goal_text_extrinsic)
